"""Generate a basic PDF for annual report output."""
...
def main() -> int:
    output_path = Path(__file__).with_name("annual_report.pdf")
    write_simple_pdf(output_path, "created annual report")
    print(f"Annual report PDF created at {output_path}")
    return 0
